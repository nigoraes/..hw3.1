...
public class MainActivity extends AppCompatActivity {
    ...
    private void initListener() {
        btn_send.setOnClickListener(view -> {
            if(!ed_email.getText().toString().isEmpty() && !ed_theme.getText().toString().isEmpty() && !ed_massage.getText().toString().isEmpty()) {
                ...
                email.putExtra(Intent.EXTRA_TEXT, ed_massage.getText().toString());
